...
int main(int argc, char *argv[])
{
   ...
   AddColumn<ProblemN3>(prAdapter, "roadLength", &ProblemN3::roadLength);
   AddColumn<ProblemN3>(prAdapter, "range", &ProblemN3::range);
   AddColumn<ProblemN3>(prAdapter, "towers", &ProblemN3::towers);
   ...
   for (int i = 0; i < (int) problems.size(); ++i)
   {
      ...
      theProblem.student_answer = MinStations(theProblem.roadLength, theProblem.range, theProblem.towers);
   }
